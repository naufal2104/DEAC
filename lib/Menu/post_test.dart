...
class _PostTestScreenState extends State<PostTestScreen> {
  ...
  bool isLearnSelected = false;
  bool isPostTestSelected = true; 
  bool isInfoSelected = false;

  @override
  void initState() {
    super.initState();
    // Timer ganti iklan setiap 3 detik
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // AppBar dengan tinggi yang disesuaikan
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(screenHeight * 0.1),
        child: Container(
          color: Color(0xFF00A9FA), // Warna ditekan
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 20.0), // padding vertikal
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Row(
                  children: [
                    Icon(Icons.account_circle, color: Colors.white, size: 50), // Ukuran ikon 
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight: FontWeight.bold, // Ukuran font 
                      ),
                    ),
                  ],
                ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Container(
                height: screenHeight * 0.17, // Tinggi iklan
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
                ),
                child: PageView(
